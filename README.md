...
- npm (recommended if you have Node.js):
  ...
  3. In VS Code, open the Run and Debug view and choose the configuration `Launch Chrome (http://localhost:8080)` then press Start. It will open `Beranda.html` from the frontend folder on the server.
...
- Live Server VS Code extension:
  ...
  2. Right-click `frontend/Beranda.html` and choose `Open with Live Server`.
